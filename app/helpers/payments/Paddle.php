		...
		$html = '<div class="form-group">
                ...
                View::push("<script>$('#paddle\\\[enabled\\\]').change(function(){ 
                    ...
                    if($(this).is(':checked') && $('#stripe\\\[enabled\\\]').is(':checked')){
                        $('#paddle\\\[enabled\\\]').parents('.form-group').before('<div class=\"alert alert-danger p-3\">".e('You cannot enable both basic Stripe and Paddle at the same time because they both work in the same way. You must choose one.')."</div>');
                    }
