 ...
 */
  ...
  define('DBhost', 'app.elsufragio.edu.co');      // Your mySQL Host (usually Localhost)
  define('DBname', 'mastertools');         // The database name where the data will be stored
  define('DBuser', 'mastertools');         // Your mySQL username
  define('DBpassword', 'h4Ph1zEGWrvxti49');        //  Your mySQL Password 
  ...
  define('AuthToken', 'PUS61a7482816249b974fbab5b8b5eb99915dfa92ade2cc5ad5df77f97c1d350b6c');
  define('EncryptionToken', 'def0000021f3b33c32f079a2ed66f57d9fd53ecb6a37c73889f9220197337780de6b91648f13384381c7d1bb332888f97106064ce883ffa026a1e4897f02d97c933e322d');
  define('PublicToken', '75512a789c34bd7bc4eee0c79f78b0ac');