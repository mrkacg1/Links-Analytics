  ...
  <div class="col-md-3">
    <div class="card card-default">
      ...
      <div class="card-body">
        ...
        <p><?php ee('You can override the default english language by creating a new language with "en" code (only works if you use the "en" code). You can use this method to text without going into core files.') ?>
      </div>
    </div>
    <div class="card card-default">
