                ...
                <div class="card-body">
                    <div class="d-flex mb-5">
                        ...
                        <?php if(config('cdn')->key && config('cdn')->secret && config('cdn')->region): ?>
                            <div class="ms-auto">
                                <a href="<?php echo route('admin.settings.cdnsync', [\Core\Helper::nonce('cdnsync')]) ?>" class="btn btn-success"><span data-bs-toggle="modal" data-bs-target="#syncing"><?php ee('Sync') ?></span></a>
                            </div>
                        <?php endif ?>
                    </div>                    
                    <p>
