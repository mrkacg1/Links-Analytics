                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <?php else: ?>
                                    <li><a class="dropdown-item" data-bs-toggle="modal" data-trigger="modalopen" data-bs-target="#deleteModal" href="<?php echo route('admin.subscription.markas', [$subscription->id, 'cancel']) ?>"><i data-feather="x-circle"></i> <?php ee('Cancel') ?></a></li>
                                <?php endif ?>                        
