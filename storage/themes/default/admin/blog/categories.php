<h1 class="h3 mb-5"><?php ee('Blog Categories') ?></h1>
<div class="row">
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a class="dropdown-item" data-bs-toggle="modal" data-trigger="modalopen" data-bs-target="#deleteModal" href="<?php echo route('admin.blog.category.delete', [$category->id, \Core\Helper::nonce('category.delete')]) ?>"><i data-feather="trash"></i> <?php ee('Delete') ?></a></li>
                                        </ul>
                                    </td>
                                </tr>
                            <?php endforeach ?>
    ...
    <div class="modal-content">
        <form action="#" method="post">
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-4">
                    <label for="newslug" class="form-label"><?php ee('Slug') ?></label>
                ...
                <div class="form-group">
                    <label for="newstatus" class="form-label"><?php ee('Status') ?></label>
                    <div class="form-check form-switch">
