                    ...
                    <div class="col-md-6 mb-3">
                        <div class="card flex-fill h-100">
                            <div class="card-body position-relative">
                                ...
                                <a href="<?php echo $bio->url ?>" target="_blank"><strong><?php echo $bio->name ?: 'n\a' ?></strong></a> <?php echo (user()->defaultbio == $bio->id ? '<span class="badge bg-primary">'.e('Default').'</span>' : '') ?><?php if($bio->status == '0') : ?>
