...
<form action="<?php echo route('shorten') ?>" method="post" data-trigger="shorten-form" enctype="multipart/form-data">
    ...
    <div class="collapse" id="advancedOptions">
        ...
        <div class="d-flex mt-4">
            <button type="button" class="btn btn-primary ms-auto" data-bs-toggle="dropdown" aria-expanded="false"><?php ee('Customize') ?> <i data-feather="more-horizontal"></i></button>
        ...
        <?php endif ?>
        <?php if(\Core\Auth::user()->has("language") !== false):?>
            <div class="collapse mt-4" id="language">
                <hr>
                <div class="d-flex">
                ...
                <div class="row" data-toggle="addable" data-label="language">
                    ...
                    <div class="col-sm-6 mt-3">
                        <div class="input-group">
                            <span class="input-group-text bg-white"><i data-feather="link"></i></span>
                            <input type="text" name="ltarget[]" class="form-control border-start-0 ps-0" placeholder="<?php echo e("Type the url to redirect user to.")?>">
                        </div>
                    </div>
                </div>
            </div>
