<div class="d-flex">
    ...
    <div class="ms-auto">
        <?php if(\Core\Auth::user()->teamPermission('pixel.create')): ?>
...
<div class="row">
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="float-end">
                                            ...
                                            <?php if(\Core\Auth::user()->teamPermission('pixel.edit')): ?>
    ...
    <div class="col-md-3">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-3"><?php ee('Pixels') ?> <small class="float-end"><?php echo $count ?> / <?php echo $total == 0 ? e('Unlimited') : $total ?></small></h5>
                <div class="progress">
