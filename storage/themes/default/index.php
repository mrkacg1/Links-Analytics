                            ...
                            <div class="card shadow-sm border-0 mb-3">
                                <div class="card-body p-3">
                                    ...
                                    <div class="d-flex align-items-center mt-3">
                                        <div>
                                            <?php echo $testimonial->email ? '<div class="h-100"><img src="https://www.gravatar.com/avatar/'.md5(trim($testimonial->email)).'?s=64&d=identicon" class="avatar avatar rounded-circle bg-warning text-white" alt="'.$testimonial->name.'"></div>': '' ?>
                                        </div>
                                        <div class="pl-3">
                                            <span class="h6 text-sm mb-0"><?php echo $testimonial->name ?>  <?php echo $testimonial->job  ? "<br><small class=\"opacity-8\">{$testimonial->job}</small>" : "" ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
