...
<div class="row">
                        ...
                        <?php foreach($domains as $domain): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if(\Core\Auth::user()->teamPermission('domain.edit')): ?>
    ...
    <div class="col-md-3">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-3"><?php ee('Domains') ?> <small class="float-end"><?php echo $count ?> / <?php echo $total == 0 ? e('Unlimited') : $total ?></small></h5>
                <div class="progress">
